...
function contextual_row($filename) {
    ...
    <td colspan="4">
        <nav class="flexible_row contextual__nav">
            <a class="expand" tabindex="0"><i class="fa fa-expand"></i> Expand</a>
            <form class="tag" action="#" method="post">
                ...
                <input type="text" placeholder="Tag this media item" >
                <button tabindex="0" type="submit" js-disabled>Save</button>
            </form>
            <form class="share" action="#" title="Share <?php echo "$filename" ?> with others">
                ...
                <button tabindex="0" type="submit" class="nued" >
